(() => {
    ...
    function menuInitFooter() {
        if (document.querySelector(".icon-menu-footer")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".icon-menu-footer")) {
                bodyLockToggle();
                document.documentElement.classList.toggle("menu-footer-open");
            }
        }));
    }
